<template>
    <div class="wrapper">
        <div style="margin: 100px auto; background-color: #fff; width: 300px; height: 380px; padding: 20px; border-radius: 10px">
            <div style="margin: 10px 0; text-align: center; font-size: 20px ;"><b>注 册</b></div>
            <el-form :model="user" :rules="rules" ref="userForm" >
                ...
                <el-form-item style="margin: 10px 0; text-align: right">
                    <el-button type="primary" size="small" style="margin: 5px "  autocomplete="off" @click="login">注册</el-button>
